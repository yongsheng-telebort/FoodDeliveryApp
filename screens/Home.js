  ...
  function renderHeader() {
    return (
      <View style={{ flexDirection: "row", height: 50 }}>
        ...
        >
          <MaterialCommunityIcons name="map-search-outline" size={30} />
        </TouchableOpacity>
        <View
        ...
        >
          <MaterialCommunityIcons name="basket" size={30} />
        </TouchableOpacity>
      </View>
    );
  }
      ...
      return (
        <TouchableOpacity
          style={{
            ...
            paddingBottom: 10,
            backgroundColor:
              selectedCategory?.id == item.id ? "tomato" : "white",
            borderRadius: 5,
            alignItems: "center",
            justifyContent: "center",
            marginRight: 5,
        ...
        >
          <View
            style={{
              ...
              justifyContent: "center",
              backgroundColor:
                selectedCategory?.id == item.id ? "white" : "lightgray",
            }}
          >
            <Image
              source={item.icon}
            ...
            >
              ...
              {[1, 2, 3].map((priceRating) => (
                <Text
                  ...
                  style={{
                    color:
                      priceRating <= item.priceRating ? "black" : "darkgray",
                  }}
                >
                  $
                </Text>
